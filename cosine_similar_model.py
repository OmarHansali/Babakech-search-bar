...
class cosin_sim():
    ...
    def cosine_similar_rugs(self, search_query, top_n, tokenizer):
    ...
    def plot(self, search, top_n, tokenizer):
        ...
        similar_data, cor_search = self.cosine_similar_rugs(search, top_n, tokenizer)
        print(f"\nMost similar rugs based on cosine similarity for {cor_search}:")
